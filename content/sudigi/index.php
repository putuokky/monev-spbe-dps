  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-xl-12 col-lg-12">
        ...
        <a class="btn btn-primary btn-icon-split h3 mb-4" title="Tambah" href="?page=sudigi&act=tambah">
          <span class="icon">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php
                  $sql = "SELECT * FROM tb_tenant a 
                  LEFT JOIN tb_inbis b ON b.id_inbis = a.nm_inbis
                  ORDER BY a.nama_tenant ASC";
                  ...
                  ?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a class="btn btn-warning" title="Edit" href="?page=sudigi&act=ubah&id=<?= $id; ?>"><i class="fas fa-fw fa-edit"></i></a>
