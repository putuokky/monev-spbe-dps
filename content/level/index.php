  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-xl-12 col-lg-12">
        ...
        <a class="btn btn-primary btn-icon-split h3 mb-4" title="Tambah" href="?page=level&act=tambah">
          <span class="icon">
                  ...
                  ?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a class="btn btn-warning" title="Edit" href="?page=level&act=ubah&id=<?= $id; ?>"><i class="fas fa-fw fa-edit"></i></a>
