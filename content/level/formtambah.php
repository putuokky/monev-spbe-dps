...
if (isset($_POST['input'])) {
  ...
  if ($res) {
    $sql = "INSERT INTO tb_level (idpertanyaan, namalevel, nilaimadiri, penjelasan_level)
      VALUES ('$namapertanyaan', '$namalevel', '$nilaimandiri' ,'$penjelasanlevel')";
          ...
          <div>
            <form method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" name="namalevel" id="namalevel" placeholder="Enter Nama Level" autocomplete="off">
                </div>
              </div>
              <div class="form-group row">
                <label for="nilaimandiri" class="col-md-2 col-form-label">Nilai Mandiri</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" name="nilaimandiri" id="nilaimandiri" placeholder="Enter Nilai Mandiri" autocomplete="off">
                </div>
              </div>
              <div class="form-group row">
