  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-xl-12 col-lg-12">
        ...
        <a class="btn btn-primary btn-icon-split h3 mb-4" title="Tambah" href="?page=grupuser&act=tambah">
          <span class="icon">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      <tr>
                        ...
                        <td><button type="button" class="btn btn-dark" title="Detail" data-toggle="modal" data-target="#modalDetail-<?= $id; ?>"><i class="fas fa-fw fa-file"></i></button>
                          <a class="btn btn-warning" title="Edit" href="?page=grupuser&act=ubah&id=<?= $id; ?>"><i class="fas fa-fw fa-edit"></i></a>
