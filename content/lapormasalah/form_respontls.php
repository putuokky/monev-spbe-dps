    ...
    <div class="col-xl-12 col-lg-12">
      <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Form Respon Tindak Lanjut Selesai <?php include 'template/title.php'; ?></h6>
        </div>
        <div class="card-body">
          <div>
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <textarea class="form-control" id="respontl" name="respontl" rows="3" placeholder="Enter Respon Tindak Lanjut"><?= $data['respon_lapor']; ?></textarea>
                </div>
              </div>
