  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-xl-12 col-lg-12">
        ...
        <a class="btn btn-primary btn-icon-split h3 mb-4" title="Tambah" href="?page=inbis&act=tambah">
          <span class="icon">
                ...
                <tbody>
                  ...
                  ?>
                      ...
                      <tr>
                        <td><?= $no; ?></td>
                        <td>
                          <a class="btn btn-warning" title="Edit" href="?page=inbis&act=ubah&id=<?= $id; ?>"><i class="fas fa-fw fa-edit"></i></a>
