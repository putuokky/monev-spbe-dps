...
if (isset($_POST['update'])) {
  ...
  $lokasi = "assets/img/aplikasi/infoapp/";

  // path lokasi gambar
  $file = $lokasi . "" . $data['infoapp'];
          ...
          if (move_uploaded_file($tmp_file, $path)) {
            ...
            if (mysqli_query($conn, $sql)) {
              echo '<script type="text/javascript">
                    alert("Info Aplikasi Data Aplikasi Berhasil Ditambah");
                    window.location.href="t.php?page=app";
                    </script>';
            } else {
              echo '<script type="text/javascript">
                    alert("Info Aplikasi Data Aplikasi Gagal Ditambah");
                    window.location.href="t.php?page=app&act=upicon&id=' . $id . '";
                    </script>';
            }
          } else {
    ...
    <div class="col-xl-12 col-lg-12">
      <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Form Upload Info <?php include 'template/title.php'; ?></h6>
        </div>
        <div class="card-body">
          <div>
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                <label for="namakatapp" class="col-md-2 col-form-label">File Info Aplikasi</label>
                <div class="col-md-10">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  Anda dapat mengupload format <b>JPG, JPEG, PNG</b>. Maximum file size <b>5 MB</b>.
                </div>
              </div>
