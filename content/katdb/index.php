  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-xl-12 col-lg-12">
        ...
        <a class="btn btn-primary btn-icon-split h3 mb-4" title="Tambah" href="?page=katdb&act=tambah">
          <span class="icon">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php
                  $sql = "SELECT * FROM kategori_database";
                  ...
                  ?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a class="btn btn-warning" title="Edit" href="?page=katdb&act=ubah&id=<?= $id; ?>"><i class="fas fa-fw fa-edit"></i></a>
